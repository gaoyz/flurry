Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/gaoyz/flurry.git', :tag => '5.4.0' }
  s.description = 'FlurrySDK for analytics tracking and reporting.'
  s.platform = :ios
  s.source_files      = 'Flurry/*.h','FlurryAds/*.h'
	s.preserve_paths    = 'Flurry/libFlurry_5.4.0.a', 'FlurryAds/libFlurryAds_5.4.0.a'
	s.library           = 'Flurry_5.4.0', 'FlurryAds_5.4.0'
